...
```bash
npm install --global current-year-cli@^0.1.0
```
...
```bash
yarn global add current-year-cli@^0.1.0
```
...
```bash
npm install --global @jaid/current-year-cli@^0.1.0
```
